            ...
            <Navbar/>
            {
                ...
                <div className="flex flex-col  gap-4 mb-10 pt-16 mt-28">
                    ...
                    <table className="w-full flex items-center justify-center  ">
                        <tbody className="border rounded-lg w-[80%] flex items-center justify-center  bg-[#111111]">
                            <List coin={coinData}/>
                        </tbody>
                    </table>
                    <div className="space-y-3 mt-6 lg:mt-10 w-[80%] ml-auto mr-auto">
                        <div className="bg-[#111111] rounded-lg p-5 items-start justify-center flex flex-col gap-10 w-full">
