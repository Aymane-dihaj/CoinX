    ...
    <Link to={`/coin/${coin.id}`} className='w-full'>
      <tr className=' flex items-center justify-between  w-full  p-4  hover:bg-white/[0.1]  hover:rounded-xl transition-all ease-in-out'>
          ...
          <Tooltip title="Total Volume">
            <td className='hidden lg:flex w-[33%] md:w-[20%] tracking-wide text-white/[0.7]  pl-12'>{coin.total_volume}</td>
          </Tooltip>
          <Tooltip title="Market Cap">
            <td className='hidden lg:flex w-[33%] md:w-[20%] tracking-wide text-white/[0.7]  pl-12'>${coin.market_cap}</td>
          </Tooltip>
          {/* </td> */}
      </tr>
    </Link>
