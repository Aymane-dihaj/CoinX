  ...
  return (
    <main className='flex flex-col lg:flex-row md:justify-evenly h-[100vh] lg:justify-between pt-48 lg:pt-28   md:items-center w-full gap-0 p-5 '>
      <div className=' flex flex-col justify-center h-fit gap-3 lg:pl-10'>
          <h1 className='text-white text-5xl text-center lg:text-start md:text-6xl lg:text-8xl max-w-4xl md:max-w-4xl 
          lg:max-w-3xl font-semibold '>Real-Time Crypto <span className='text-themeColor'>Insights</span></h1>
